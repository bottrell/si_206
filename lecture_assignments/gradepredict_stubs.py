...
def test():
	...
	expected_ouput = 20 * 12
	
	homeworks2 = [10, 10, 12, 12, 14, 14, 16, 16, 18, 18, 20, 20, 22, 22]
	expected_ouput2 = 12 + 12+ 14 + 14+ 16 + 16 + 18+ 18+ 20 + 20+ 22 + 22
	
	if calculate_homework_score(homeworks) == expected_ouput:
		pass
	else:
		print("fail")

	if calculate_homework_score(homeworks2) == expected_ouput2:
		print("pass2")
	else:
		print("fail2")
